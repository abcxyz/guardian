...
func TestEnviron(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:        "allow_all",
			osEnv:       []string{"os_key1=key1_value", "os_key2=key2_value"},
			allowedKeys: []string{"*"},
			deniedKeys:  []string{},
			overrideEnv: []string{},
			exp:         []string{"os_key1=key1_value", "os_key2=key2_value"},
		},
		{
			name:        "empty_osenv",
			osEnv:       []string{},
		...
		},
		{
			...
			osEnv:       []string{"allowed_key1=key1_value", "allowed_key2=key2_value"},
			allowedKeys: []string{"allowed_key1", "allowed_key2"},
			deniedKeys:  []string{},
			overrideEnv: []string{},
			exp:         []string{"allowed_key1=key1_value", "allowed_key2=key2_value"},
		},
		{
		...
		},
		{
			...
			osEnv:       []string{"denied_key1=key1_value", "denied_key2=key2_value"},
			allowedKeys: []string{},
		...
		},
		{
			...
			osEnv: []string{
				"allowed_key1=key1_value", "allowed_key2=key2_value",
				"denied_key1=key1_value", "denied_key2=key2_value",
			},
			allowedKeys: []string{"allowed_*"},
			deniedKeys:  []string{"denied_*"},
			overrideEnv: []string{},
