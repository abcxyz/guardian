...
var defaultURIFilterPatterns = []*regexp.Regexp{
	regexp.MustCompile(`aiplatform\.colabServiceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-vertex-nb\.iam\.gserviceaccount\.com`),
	regexp.MustCompile(`aiplatform\.notebookServiceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-aiplatform-vm\.iam\.gserviceaccount\.com`),
	...
	regexp.MustCompile(`bigqueryconnection\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-bigqueryconnection\.iam\.gserviceaccount\.com`),
	...
	regexp.MustCompile(`chronicle\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-chronicle\.iam\.gserviceaccount\.com`),
	regexp.MustCompile(`cloudaicompanion\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-cloudaicompanion\.iam\.gserviceaccount\.com`),
	...
	regexp.MustCompile(`composer\.serviceAgent\/serviceAccount:service-(?:\d*)@cloudcomposer-accounts\.iam\.gserviceaccount\.com`),
	...
	regexp.MustCompile(`dataplex\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-dataplex\.iam\.gserviceaccount\.com`),
	...
	regexp.MustCompile(`datastream\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-datastream\.iam\.gserviceaccount\.com`),
	regexp.MustCompile(`dialogflow\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-dialogflow\.iam\.gserviceaccount\.com`),
	...
	regexp.MustCompile(`gkeonprem\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-gkeonprem\.iam\.gserviceaccount\.com`),
	...
	regexp.MustCompile(`managedidentities\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-mi\.iam\.gserviceaccount\.com`),
	regexp.MustCompile(`managedkafka\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-managedkafka\.iam\.gserviceaccount\.com`),
	...
	regexp.MustCompile(`networkactions\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-networkactions\.iam\.gserviceaccount\.com`),
	regexp.MustCompile(`networkconnectivity\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-networkconnectivity\.iam\.gserviceaccount\.com`),
	...
	regexp.MustCompile(`serviceextensions\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-dep\.iam\.gserviceaccount\.com`),
	...
	regexp.MustCompile(`vmmigration\.serviceAgent\/serviceAccount:service-(?:\d*)@gcp-sa-vmmigration\.iam\.gserviceaccount\.com`),
