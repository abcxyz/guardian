...
func (c *PlanCommand) Process(ctx context.Context) error {
	...
	startComment, err := c.githubClient.CreateIssueComment(
		...
		fmt.Sprintf("%s 🟨 Started...", planCommentPrefix),
	)
	if err != nil {
	...
	if err != nil {
		...
		comment.WriteString(fmt.Sprintf("%s 🟥 Failed for dir: `%s`\n\n<details>\n<summary>Error</summary>\n\n```\n\n%s\n```\n</details>", planCommentPrefix, c.flagWorkingDirectory, err))
		...
		comment.WriteString(fmt.Sprintf("%s 🟩 Successful for dir: `%s`", planCommentPrefix, c.flagWorkingDirectory))
		if result.commentDetails != "" {
			comment.WriteString(fmt.Sprintf("\n\n<details>\n<summary>Details</summary>\n\n```diff\n\n%s\n```\n</details>", result.commentDetails))
		}
